...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-900 px-4 py-8 sm:px-6 lg:px-8">
      <Card className="w-full max-w-md space-y-6 sm:space-y-8 bg-zinc-800/30 backdrop-blur-lg border-zinc-700">
        <CardHeader className="space-y-2 sm:space-y-3">
          <CardTitle className="text-center text-2xl sm:text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-zinc-200 via-zinc-400 to-zinc-500">
            Sign in to Triptify
          </CardTitle>
        </CardHeader>
        <CardContent>
          <form className="space-y-4 sm:space-y-6" onSubmit={handleLogin}>
            ...
            <div>
              <Button
                type="submit"
                className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-zinc-900 bg-gradient-to-r from-zinc-200 via-zinc-400 to-zinc-500 hover:from-zinc-300 hover:via-zinc-500 hover:to-zinc-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-zinc-500 disabled:opacity-50 disabled:cursor-not-allowed"
                disabled={isLoading}
              >
                {isLoading ? (
                  <>
