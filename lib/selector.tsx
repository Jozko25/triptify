    ...
    <div ref={ref}>
      <div className="mt-1 relative">
        ...
        >
          ...
          <span
            className={`absolute inset-y-0 right-0 flex items-center pr-2 pointer-events-none cursor-pointer ${
              disabled ? "hidden" : ""
            }`}
          >
            <svg
        ...
        <AnimatePresence>
          {open && (
            <motion.ul
              ...
              className="cursor-pointer absolute z-10 mt-1 w-full bg-white shadow-lg max-h-80 rounded-md text-base ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
              tabIndex={-1}
              role="listbox"
              aria-labelledby="listbox-label"
